(custom-set-variables
 ...
 '(package-selected-packages
   '(w3m org-inlinetask restart-emacs multiple-cursors wordnut org-pdftools org-noter-pdftools undo-tree pretty-hydra lsp-ivy helpful frame-local elisp-refs xr writeroom-mode writegood-mode visual-fill-column vertico flyspell-correct-ivy zoutline page-break-lines embark-consult embark orderless marginalia org-contrib magit-todos org-roam-bibtex epc org-pomodoro ox-timeline mu4e-maildirs-extension org-ql org rainbow-delimiters zeal-at-point ace-pinyin emojify helm-org-rifle helm-org-rfile helm-org benchmark-init esup youdao-dictionary xref tablist simple-httpd shrink-path request-deferred project pos-tip persist parsebib org-superstar org-noter noflet names mu4e-alert memoize log4e key-chord jsonrpc htmlize helm-core helm-bibtex helm gntp flyspell-correct flymake emacsql-sqlite3 emacsql-sqlite emacsql elfeed-org elfeed-goodies elfeed eldoc doom-themes doom-modeline deferred dash-functional chinese-word-at-point calibredb bibtex-completion biblio-core biblio all-the-icons alert ace-jump-mode vterm wttrin quelpa-use-package mpv org-download anki-editor golden-ratio lsp-mode goldendict quickrun org-mind-map dashboard beacon dap-mode lsp-treemacs lsp-ui ccls yasnippet-snippets auto-yasnippet flycheck wgrep grab-x-link iedit expand-region which-key pad-tools magit rime saveplace-pdf-view company use-package hungry-delete smex smartparens popwin))
