(custom-set-variables
 ...
 '(package-selected-packages
   '(ox-pandoc modern-cpp-font-lock elfeed elfeed-org ace-jump-mode noflet ess-smart-equals ess flycheck-posframe flycheck lsp-ui lsp-treemacs helm-bibtex dap-mode citre cdlatex ccls auctex lsp-latex lsp-mode preview ebib org-roam-bibtex citar eglot ox-org org-mu4e company-box company-prescient treemacs spinner pfuture markdown-mode cfrs bui ace-window easy-hugo ox-hugo dap-cpptools powerline lyrics-fetcher cal-china-x spray emms amread-mode keyfreq shrface nov yaml-mode rime w3m org-inlinetask restart-emacs multiple-cursors wordnut org-pdftools org-noter-pdftools undo-tree pretty-hydra helpful frame-local elisp-refs xr writeroom-mode writegood-mode visual-fill-column vertico zoutline page-break-lines embark-consult embark orderless marginalia org-contrib magit-todos epc org-pomodoro ox-timeline mu4e-maildirs-extension org-ql org rainbow-delimiters zeal-at-point ace-pinyin helm-org-rifle helm-org-rfile helm-org benchmark-init esup youdao-dictionary xref tablist simple-httpd shrink-path request-deferred project pos-tip persist parsebib org-superstar org-noter noflet names mu4e-alert memoize log4e key-chord jsonrpc htmlize helm-core helm gntp flyspell-correct flymake emacsql-sqlite3 emacsql-sqlite emacsql eldoc doom-themes doom-modeline deferred dash-functional chinese-word-at-point calibredb bibtex-completion biblio-core biblio all-the-icons alert ace-jump-mode vterm wttrin quelpa-use-package mpv org-download anki-editor golden-ratio goldendict quickrun org-mind-map dashboard beacon auto-yasnippet wgrep grab-x-link iedit expand-region which-key pad-tools magit saveplace-pdf-view company use-package hungry-delete smex smartparens popwin))
