(custom-set-variables
 ...
 '(dynamic-agenda-files '("/home/eli/Dropbox/org/inbox.org_archive") t)
 '(large-file-warning-threshold 1000000000)
 '(org-agenda-files
   '("/home/eli/Dropbox/org/inbox.org" "/home/eli/Dropbox/org/daily.org" "/home/eli/Dropbox/org/words.org" "/home/eli/Dropbox/org/Clock_Report.org" "/home/eli/Dropbox/org/habits.org" "/home/eli/Dropbox/org/journal.org" "/home/eli/Dropbox/org/notes.org" "/home/eli/Dropbox/org/projects.org"))
 ...
 '(package-selected-packages
   '(kind-icon org-roam-bibtex org-latex-impatient xenops all-the-icons-dired smartparens consult-yasnippet cape corfu lyrics-fetcher elfeed-score lsp-ui lsp-treemacs lsp-latex dap-mode flycheck-popup-tip svg-lib prescient org-media-note-org-ref dired-x pcre2el with-editor magit-todos magit hl-todo git-commit marginalia memory-usage org-roam org-ref bibtex-completion oc ox-pandoc modern-cpp-font-lock elfeed elfeed-org ace-jump-mode noflet ess-smart-equals ess flycheck-posframe flycheck citre cdlatex ccls auctex preview ebib citar ox-org org-mu4e treemacs spinner pfuture markdown-mode cfrs bui ace-window easy-hugo ox-hugo dap-cpptools powerline cal-china-x spray emms amread-mode keyfreq shrface nov yaml-mode rime w3m org-inlinetask restart-emacs multiple-cursors wordnut org-pdftools org-noter-pdftools undo-tree pretty-hydra helpful frame-local elisp-refs xr writeroom-mode writegood-mode visual-fill-column vertico zoutline page-break-lines embark-consult embark orderless org-contrib epc org-pomodoro ox-timeline mu4e-maildirs-extension org-ql org rainbow-delimiters zeal-at-point ace-pinyin helm-org-rifle helm-org-rfile helm-org esup youdao-dictionary xref tablist simple-httpd shrink-path request-deferred project pos-tip persist parsebib org-superstar org-noter noflet names mu4e-alert memoize log4e key-chord jsonrpc htmlize helm-core helm gntp flyspell-correct flymake emacsql-sqlite3 emacsql-sqlite emacsql eldoc doom-themes doom-modeline deferred dash-functional chinese-word-at-point calibredb biblio-core biblio all-the-icons alert ace-jump-mode vterm wttrin quelpa-use-package mpv org-download anki-editor golden-ratio goldendict quickrun org-mind-map dashboard beacon auto-yasnippet wgrep grab-x-link iedit expand-region which-key pad-tools saveplace-pdf-view use-package hungry-delete smex popwin))
